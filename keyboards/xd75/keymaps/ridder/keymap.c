 ...
 */
 ...
 [QWERTY_SPLIT] = { /* QWERTY */
  ...
  { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,        KC_T,   XXXXXXX, KC_BSLS, XXXXXXX, KC_Y,   KC_U,      KC_I,    KC_O,    KC_P,    KC_ENT  },
  { EscNavS, KC_A,    KC_S,    KC_D,    KC_F,        KC_G,   KC_HOME, KC_UP  , KC_END , KC_H,   KC_J,      KC_K,    KC_L,    SclNavS, KC_QUOT },
  { KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,        KC_B,   KC_LEFT, KC_DOWN, KC_RGHT, KC_N,   KC_M,      KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC },
  { LCTL_BR, LHYP_BR, KC_LALT, KC_LGUI, MO(LOWER_S), KC_SPC, KC_ENT , KC_DOWN, KC_ENT , KC_SPC, MO(RAISE_S), KC_RGUI, KC_RALT, RHYP_BR , RCTL_BR },
 },
